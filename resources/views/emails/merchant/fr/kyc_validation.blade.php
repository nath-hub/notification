...
<head>
    ...
    <style>
        ...
        .approval-message {
            background-color: #F0FFF0; /* Vert clair */
            padding: 15px;
            border-radius: 6px;
            border: 1px solid #2E8B57;
        }
        .rejection-message {
            background-color: #FFF0F0; /* Rouge clair */
            padding: 15px;
            border-radius: 6px;
...
<body>
    <div class="container">
        <div class="header">
            <h1>{{ $kycStatus === 'approved' ? trans('merchant.kyc_approved.subject') : trans('merchant.kyc_rejected.subject') }}</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="kyc-details">
                <p><strong>{{ trans('merchant.kyc_validation.business_name') }}:</strong> <span class="bordeaux">{{ $merchant['business_name'] }}</span></p>
