{{-- resources/views/emails/fr/password_reset_code.blade.php --}}
                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td style="padding:30px; color:#333333; font-size:16px; line-height:1.6;">
                            ...
                            <!-- Code box -->
                            <div
                                style="background:#f4f4f4; border-radius:8px; padding:25px; text-align:center; margin:30px 0;">
                                <h1
                                    style="color:#2E7D32; font-size:36px; font-weight:bold; letter-spacing:6px; margin:0;">
                                    {{ trans('emails.verification.code') }}
                                </h1>
                            </div>
